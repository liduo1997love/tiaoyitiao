...
def is_same_point(x1, y1, x2, y2):
    # print("edges_rect is_same_point:", abs(x1 - x2), abs(y1 - y2))
...
def check_two_line(i1x, i1y, i2x, i2y, p1x, p1y, p2x, p2y, ax, ay, a, b, c):
    ...
    if same_p and (same_x or same_y):
        ...
        print("edges_rect p_l_dis p_a_dis p_l_dis_li:", point_line_dis, point_agent_dis, point_line_dis_max + try_time*incr)
        if point_line_dis < point_line_dis_max + try_time*incr and ty < ay and point_agent_dis > point_agent_dis_max:
            return True, tx, ty
    return False, -1, -1
